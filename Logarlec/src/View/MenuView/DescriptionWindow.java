...
public class DescriptionWindow extends JFrame {
    public DescriptionWindow() {
        ...
        textArea.setFont(new Font("SansSerif", Font.PLAIN, 14)); // Betűtípus és méret beállítása
        ...
        scrollPane.setPreferredSize(new Dimension(700, 500)); // Méret beállítása a scroll panelnek
